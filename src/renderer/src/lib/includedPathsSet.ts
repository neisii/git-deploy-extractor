...
// MissingDependenciesPane·DeployFilesPanel(수동 추가 후보 계산)이 각자
// 독립된 컴포넌트로 나뉘면서 셋 다 이 값이 필요해졌는데, 굳이
// useIncludedFilesView 전체(필터링 파이프라인)를 반복 호출할 필요 없이
// 이 값만 저렴하게 따로 구할 수 있게 뺐다.
